    ...
    return (
        <div className="flex h-screen w-full bg-white">
            ...
            <div className="flex w-full flex-col justify-between bg-white p-8 lg:w-1/2">
                ...
                <div className="flex flex-col items-center justify-center">
                    <div className="w-full max-w-sm">
                        ...
                        />
                        <div className="w-full text-center text-xs text-neutral-500"><span>Don't have an account? <Link href="/sign-up" className="text-[#242424] hover:text-[#242424]/90">Sign Up</Link></span></div>
                    </div>
                </div>
            ...
            <div className="hidden w-1/2 p-6 lg:flex flex-col">
                <AuthRightSide
                    title="Access your global talent network"
                />
            </div>
        </div>
    );
